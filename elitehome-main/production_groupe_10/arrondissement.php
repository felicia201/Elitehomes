...
<head>
  ...
  <title>Carte de Paris et environs</title>
...
<body>
  ...
  <script>
    ...
    for (var i = 0; i < arrondissementsParis.length; i++) {
      ...
      var marker = L.marker(arrondissement.latlng)
    ...
    function displayApartments(apartments) {
      ...
      if (apartments.length === 0) {
        apartmentsInfo.innerHTML = '<p>Aucune résidence disponible dans cet arrondissement.</p>';
        return;
      }
